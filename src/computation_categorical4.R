...
#-----------------------------------------------设定
n_0_list <- c(50000)  #样本量
n_0_list2 <- c(500,800,1200,1600,2000,3000)
n_1_list <- c(400)
gamma_list <- c(1) #gamma大小的调节参数
                          ...
                          tryCatch({
                            ...
                            if(p_Znm>0){
                              ...
                              if(p_Zm == 0){
                                ...
                                #Trans_IPW
                                X_hat_matrix_IPW <- Trans_KNN2(Z_0=Z_0m,Z_1=Z_1m,C_0=C_0,C_1=C_1,X_1=X_1)$X_hat_matrix
                              ...
                              #Trans_IPW
                              X_hat_matrix_IPW <- Trans_KNN2(Z_0=Z_0,Z_1=Z_1,C_0=C_0,C_1=C_1,X_1=X_1)$X_hat_matrix
                            ...
                            #----------------------------结果保存
                            beta_hat_vec <- c(beta_hat_1, beta_hat_2, beta_hat_3)
                            #--------------------------------------------------IVW方差计算
