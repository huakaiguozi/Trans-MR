                          ...
                          tryCatch({
                            ...
                            if(p_Znm>0){
                              ...
                              if(p_Zm == 0){
                                ...
                                if(p_Zm >= 1){
                                  for (i in 1:p_Zm) {  
                                    model2 <- lm(Y_0~X_hat_matrix_OR[,i] + Z_0m[,i])  #有Z
                                    ...
                                    if(Z_pval < pval_i){
                                      ...
                                      model2_1 <- lm(Y_0~X_hat_matrix_OR[,i])  #无Z
                                ...
                                if(p_Zm>=1){
                                  ...
                                  for (i in 1:p_Zm) {
                                    ...
                                    model3 <- lm(Y_0~X_hat_matrix_IPW[,i] + Z_0m[,i])  #有Z
                                    ...
                                    if(Z_pval < pval_i){
                                      ...
                                      model3_1 <- lm(Y_0~X_hat_matrix_IPW[,i])  #无Z
                                ...
                                if(p_Zm>=1){
                                  ...
                                  for (i in 1:p_Zm) {
                                    model4 <- lm(Y_0~X_hat_matrix_AIPW[,i] + Z_0m[,i])  #有Z
                                    ...
                                    if(Z_pval<pval_i){
                                      ...
                                      model4_1 <- lm(Y_0~X_hat_matrix_AIPW[,i])  #无Z
                              ...
                              #---------------------------------------------------------------Trans_OR0         21
                              for (i in 1:p_Z) {  
                                model2 <- lm(Y_0~X_hat_matrix_OR[,i] + Z_0[,i])  #有Z
                                summary_model2 <- summary(model2)
                                pval_model2 <- summary_model2$coefficients[,4]
                                Z_pval <- pval_model2[length(pval_model2)]
                                print(as.numeric(Z_pval))
                              ...
                              for (i in 1:p_Z) {
                                ...
                                model3 <- lm(Y_0~X_hat_matrix_IPW[,i] + Z_0[,i])  #有Z
                                summary_model3 <- summary(model3)
                                pval_model3 <- summary_model3$coefficients[,4]
                                Z_pval <- pval_model3[length(pval_model3)]
                                print(as.numeric(Z_pval))
                              ...
                              #---------------------------------------------------------------Trans_AIPW0          41
                              for (i in 1:p_Z) {
                                model4 <- lm(Y_0~X_hat_matrix_AIPW[,i] + Z_0[,i])  #有Z
                                summary_model4 <- summary(model4)
                                pval_model4 <- summary_model4$coefficients[,4]
                                Z_pval <- pval_model4[length(pval_model4)]
                                if(Z_pval < pval_i){
