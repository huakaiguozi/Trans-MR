...
color_setting <- color_setting[1:len_methods]
#===============================================================================
...
#     theme_bw() +
#     scale_y_continuous(limits = c(kedu_down-0.03, kedu_up+0.03), 
...
#------------------------------------------
#-----------
data_gamma_beta <- save_df[save_df$heterogeneity == heter_level_list[k_heter] & save_df$n_0 == n_0_list[k_n0] & save_df$inter_ratio == ratio_inter_list[k_inter] & save_df$p_Z == p_Z_list[k_pz] & save_df$inter_strength == inter_strength_list[k_inter_strength] & save_df$alpha_modifier == alpha_list[k_alpha] & save_df$eta_modifier == eta_list[k_eta] & save_df$beta == beta_list[len_beta], ]
data_heterogeneity_beta <- save_df[save_df$gamma == gamma_list[k_gamma] & save_df$n_0 == n_0_list[k_n0] & save_df$inter_ratio == ratio_inter_list[k_inter] & save_df$p_Z == p_Z_list[k_pz] & save_df$inter_strength == inter_strength_list[k_inter_strength] & save_df$alpha_modifier == alpha_list[k_alpha] & save_df$eta_modifier == eta_list[k_eta]& save_df$beta == beta_list[len_beta], ]
data_n0_beta <- save_df[save_df$heterogeneity == heter_level_list[k_heter] & save_df$gamma == gamma_list[k_gamma] & save_df$inter_ratio == ratio_inter_list[k_inter] & save_df$p_Z == p_Z_list[k_pz] & save_df$inter_strength == inter_strength_list[k_inter_strength] & save_df$alpha_modifier == alpha_list[k_alpha] & save_df$eta_modifier == eta_list[k_eta]& save_df$beta == beta_list[len_beta], ]
data_inter_ratio_beta <- save_df[save_df$heterogeneity == heter_level_list[k_heter] & save_df$gamma == gamma_list[k_gamma]& save_df$n_0 == n_0_list[k_n0] & save_df$p_Z == p_Z_list[k_pz] & save_df$inter_strength == inter_strength_list[k_inter_strength] & save_df$alpha_modifier == alpha_list[k_alpha] & save_df$eta_modifier == eta_list[k_eta]& save_df$beta == beta_list[len_beta], ]
data_pz_beta <- save_df[save_df$heterogeneity == heter_level_list[k_heter] & save_df$gamma == gamma_list[k_gamma]& save_df$n_0 == n_0_list[k_n0] & save_df$inter_ratio == ratio_inter_list[k_inter] & save_df$inter_strength == inter_strength_list[k_inter_strength] & save_df$alpha_modifier == alpha_list[k_alpha] & save_df$eta_modifier == eta_list[k_eta]& save_df$beta == beta_list[len_beta], ]
data_inter_strength_beta <- save_df[save_df$heterogeneity == heter_level_list[k_heter] & save_df$gamma == gamma_list[k_gamma2]& save_df$n_0 == n_0_list[k_n0] & save_df$inter_ratio == ratio_inter_list[k_inter] & save_df$p_Z == p_Z_list[k_pz] & save_df$alpha_modifier == alpha_list[k_alpha2] & save_df$eta_modifier == eta_list[k_eta]& save_df$beta == beta_list[len_beta], ]
data_alpha_beta <- save_df[save_df$heterogeneity == heter_level_list[k_heter] & save_df$gamma == gamma_list[k_gamma]& save_df$n_0 == n_0_list[k_n0] & save_df$inter_ratio == ratio_inter_list[k_inter] & save_df$p_Z == p_Z_list[k_pz]& save_df$inter_strength == inter_strength_list[k_inter_strength]& save_df$eta_modifier == eta_list[k_eta]& save_df$beta == beta_list[len_beta], ]
data_eta_beta <- save_df[save_df$heterogeneity == heter_level_list[k_heter] & save_df$gamma == gamma_list[k_gamma]& save_df$n_0 == n_0_list[k_n0] & save_df$inter_ratio == ratio_inter_list[k_inter] & save_df$p_Z == p_Z_list[k_pz]& save_df$inter_strength == inter_strength_list[k_inter_strength]& save_df$alpha_modifier == alpha_list[k_alpha]& save_df$beta == beta_list[len_beta], ]
#---
