...
data_inter_strength_beta <- save_df[save_df$heterogeneity == heter_level_list[k_heter] & save_df$gamma == gamma_list[k_gamma2]& save_df$n_0 == n_0_list[k_n0] & save_df$inter_ratio == ratio_inter_list[k_inter] & save_df$p_Z == p_Z_list[k_pz] & save_df$alpha_modifier == alpha_list[k_alpha2] & save_df$eta_modifier == eta_list[k_eta], ]
