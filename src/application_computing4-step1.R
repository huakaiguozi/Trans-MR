...
data_outcome <- data_outcomes_continuous[,1]
...
# C_all <- C_all %>% select(-all_of(c("种族背景",'BMI','PEF','地理划分')))
C_all <- C_all %>% select(-all_of(c("种族背景",'BMI','FVC','地理划分')))
# C_all <- C_all %>% select(-all_of(c("种族背景",'BMI','FEV1','地理划分')))
# C_all <- C_all %>% select(-all_of(c("种族背景",'BMI','FEV1/FVC','地理划分')))
...
# data_result1$sample <- 0
# data_result1$outcome <- 'FVC'  #'FEV1/FVC'
...
# data_result[data_result$method==method_names[2],]
# data_result[data_result$method==method_names[3],]
# data_result[data_result$method==method_names[4],]
# data_result[data_result$method==method_names[5],]
# data_result[data_result$method==method_names[6],]
# data_result[data_result$method==method_names[7],]
# data_result[data_result$method==method_names[8],]
# data_result[data_result$method==method_names[9],]
#------------------
